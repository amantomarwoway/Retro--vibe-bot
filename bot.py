...
if not downloaded:
    ...
    with requests.get("https://download.archive.org/details/moviesandfilms?tab=collection, stream=True) as r:
        with open('input.mp4','wb') as f:
            for c in r.iter_content(1024*1024):
                f.write(c)
...
if tok and pid:
    ...
    print("FB Token ya Page ID nahi mila")
